...
function testContentOverflow(cellChild) {
  ...
  var padding = (parseInt(getComputedStyle(cellChild).paddingLeft, 10) || 0) + (parseInt(getComputedStyle(cellChild).paddingRight, 10) || 0);
...
function isSingleLineOverflow(element) {
